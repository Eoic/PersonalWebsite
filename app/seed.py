...
PAGES = [
    {
        "slug": "index",
        "title": "About",
        "description": "I'm a software engineer passionate about building useful and/or interesting things for the web. You can explore my projects and work experience here.",
        "url": "/",
        "sort_order": 0,
    },
    {
        "slug": "positions",
        "title": "Positions",
        "description": "Professional work, responsibilities, and the tools I have spent the most time working with.",
        "url": "/positions",
        "sort_order": 1,
    },
    {
        "slug": "education",
        "title": "Education",
        "description": "Formal education and the technical foundation behind the way I approach software work.",
        "url": "/education",
        "sort_order": 2,
    },
    {
        "slug": "projects",
        "title": "Projects",
        "description": "Selected side projects, experiments, and longer-running ideas.",
        "url": "/projects",
        "sort_order": 3,
    },
    {
        "slug": "whiteboard",
        "title": "Whiteboard",
        "description": "Shared freehand drawing space.",
        "url": "/whiteboard",
        "sort_order": 4,
    },
    {
        "slug": "posts",
        "title": "Journal",
        "description": "Short notes, engineering updates, and occasional writing about software and side projects.",
        "url": "/posts",
        "sort_order": 5,
    },
    {
        "slug": "bookshelf",
        "title": "Bookshelf",
        "description": "Some of the books I've read. Not in any meaningful order, chronological or otherwise.",
        "url": "/bookshelf",
        "sort_order": 6,
    },
    {
        "slug": "garden",
        "title": "Garden",
        "description": "A shared, persistent garden where visitors can plant flowers, water them, and prune what has wilted.",
        "url": "/garden",
        "sort_order": 7,
    },
    {
...
PROJECTS = [
    ...
    {
        "title": "Canopy",
        "subtitle": "real time spatial conversation platform",
    ...
    {
        "title": "NetBots",
        "subtitle": "real-time multiplayer robot programming game",
    ...
    {
        "title": "JigsawQuest",
        "subtitle": "multiplayer jigsaw puzzle game",
    ...
    {"key": "learning_about", "value": json.dumps([])},
    {
        ...
        "value": json.dumps(
            [
                {
                    "title": "Papyrus",
                    "subtitle": "a cross-platform book reading and management application",
                    "link": "https://github.com/PapyrusReader/client",
                }
            ]
        ),
    },
